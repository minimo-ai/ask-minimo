  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-cream-50 to-white">
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto text-center">
        ...
        <p className="text-sm text-ink-400 mt-4">Free messages to get started. No credit card required.</p>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              {
                question: "My seller wants to overprice. How do I have that conversation?",
      ...
      <section className="px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-ink-600 text-center max-w-2xl mx-auto mb-12">
            Generic AI gives generic answers. MiniMo is powered by real Texas real estate 
            experience — new construction expertise, veteran client knowledge, and 
            ...
            {[
              {
                ...
                description: "Helps you stay mindful of what you can and can't say. Supports compliant communication."
              },
              {
                icon: "🏗️",
                title: "New Construction Expertise",
                description: "Builder contracts, design centers, negotiations — from extensive new build experience."
              },
              {
                icon: "🎖️",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <div className="border-2 border-sage-200 rounded-2xl p-8">
              ...
              <p className="text-ink-600 text-sm mb-6">Try MiniMo and see if it's right for you.</p>
              <ul className="space-y-3 mb-8">
                {[
                  "Free messages to start",
