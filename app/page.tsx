  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-cream-50 via-white to-sage-50">
      ...
      <div className="fixed inset-0 opacity-30 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blush-100 rounded-full blur-3xl opacity-40" />
      </div>
      ...
      <div className="relative px-4 py-12 md:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="animate-slide-up">
            <div className="rounded-4xl border border-sage-100 bg-white/80 backdrop-blur-sm p-8 md:p-12 shadow-softer">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold tracking-tight text-ink-800 leading-tight">
                Get clear on real estate
                <span className="text-sage-500">.</span>
                <br />
                <span className="text-sage-600">No pressure</span>
                <span className="text-coral-400">.</span>
              </h1>

              {/* Subheadline */}
              <p className="mt-6 text-lg md:text-xl text-ink-600 leading-relaxed max-w-xl">
                MiniMo helps you understand your options, know what comes next, 
                and feel confident — before you ever talk to an agent or lender.
              </p>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/ask"
                  className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-sage-500 px-8 py-4 text-lg font-semibold text-white shadow-soft hover:bg-sage-600 hover:shadow-glow transition-all duration-300"
                >
                  ...
                  href="#about"
                  className="inline-flex items-center justify-center rounded-2xl border-2 border-sage-200 bg-white px-8 py-4 text-lg font-semibold text-sage-700 hover:bg-sage-50 hover:border-sage-300 transition-all duration-300"
                >
                  Learn more
                </a>
              </div>
          ...
          {/* About Section */}
          <section id="about" className="mt-16 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="rounded-4xl border border-sage-100 bg-white/60 backdrop-blur-sm p-8 md:p-10">
              <h2 className="text-2xl font-display font-semibold text-ink-800 mb-6">
                What is MiniMo?
              </h2>
              
              <div className="space-y-4 text-ink-600 leading-relaxed">
                <p>
                  MiniMo is your clarity companion — here to help you understand real estate 
                  <em> before</em> you feel pressured to make decisions.
                </p>
                <p>
                  Whether you&#39;re just curious, actively exploring, or getting ready to take 
                  the next step, MiniMo helps you understand where you are and what comes next.
                </p>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="rounded-2xl bg-sage-50 p-5 border border-sage-100">
                  ...
                  <p className="text-sm text-ink-600">You&#39;re treated like family, not a transaction.</p>
                </div>
          ...
          <section className="mt-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="rounded-2xl border border-ink-100 bg-ink-50/50 p-6">
              ...
              <p className="text-sm text-ink-600 leading-relaxed">
                MiniMo provides educational guidance only. She is <strong>not</strong> a lender, 
                agent, attorney, or financial advisor. For specific rates, legal questions, or 
                professional advice, always consult a licensed professional.
              </p>
            </div>
          </section>
